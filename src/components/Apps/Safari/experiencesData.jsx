export const experiences = [
  {
    id: "frenchy",
    company: "Frenchy Digital",
    role: "Technical Product Manager Intern",
    location: "Los Angeles, CA, USA",
    duration: "Sep 2025 - Present",
    description:
      "Frenchy Digital is a Los Angeles–based digital agency that builds web and mobile applications for startups and enterprises around the world.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Navi is a civic-tech startup developing a mobile app that helps users navigate urban environments safely through real-time safety data and crowd-sourced insights.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Moziware is an augmented reality and AI hardware company specializing in voice-assisted smart glasses and hands-free industrial solutions.",
    bullets: [
  ...
  {
    id: "tsinghua",
    company: "Tsinghua Unisplendour",
    role: "AI Sales Analyst Intern",
    location: "Shanghai, China",
    duration: "Jun 2024 - Jul 2024",
    description:
      "Tsinghua Unisplendour is a Chinese technology conglomerate focused on cloud computing, AI, and enterprise IT solutions across Asia.",
    bullets: [
